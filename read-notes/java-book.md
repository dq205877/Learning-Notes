...
要点：synchronized对象监视器为Object时的使用/synchronized对象监视器为Class时的使用/非线程安全是如何出现的/关键字volatile的主要作用/关键字volatile与synchronized的区别及使用情况
...
CS：APP Computer Systems A Programmer's Perspective     Third Edition 第三版
